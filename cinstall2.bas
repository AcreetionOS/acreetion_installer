...
Rem Shell "pacman -S grub efibootmgr dosfstools os-prober mtools --noconfirm"
...
Rem Open "i", #1, "/tem.txt"
Rem Line Input #1, dd$
Rem Close #1
Rem Shell "rm /tem.txt"

Rem pull out Partuuid number for root drive

Rem ii = InStr(dd$, "PARTUUID=")

Rem dd$ = Mid$(dd$, ii + 1, Len(dd$) - 1)
...
Shell "chmod +x /boot/loading/entries/linux-zen.conf"
